 ...
 */
@WebServlet("/gogo-admin/staff/staffBoardList")
public class SBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(pageNo ==1) {
            ...
            pageBar += "<a href='staffBoardList?cPage="+(pageNo-1)+"'><i class='fas fa-caret-square-left' style='font-size:24px'></i></a>";
        }
        ...
        while(pageNo <= pageEnd && pageNo <= totalPage) {
            if(pageNo == cPage) {
                ...
                pageBar += "<a href='staffBoardList?cPage="+pageNo+"'><button class='w3-btn w3-white w3-border'>"+pageNo+"</button></a>";
            }   
            pageNo++;
        }
        ...
        if(pageNo > totalPage) {
            ...
            pageBar += "<a href='staffBoardList?cPage="+pageNo+"'><i class='fas fa-caret-square-right' style='font-size:24px'></i></a>";
        }   
        ...
        request.getRequestDispatcher("/WEB-INF/views/staff/staffBoardList.jsp").forward(request, response);
