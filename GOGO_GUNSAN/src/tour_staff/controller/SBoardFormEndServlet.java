 ...
 */
@WebServlet("/gogo-admin/staff/staffBoardFormEnd")
public class SBoardFormEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SBoardFormEndServlet() {
        super();
...
//								= new DefaultFileRenamePolicy();
				...
				MultipartRequest multiReq 
					...
					String staffNo = multiReq.getParameter("staffNo");
					//XSS공격대비 태그기호 치환
					//개행문자 \n => <br>
					...
					Staff_Board b =new Staff_Board(0, boardTitle, boardWriter, boardContent, originalFileName, renamedFileName, null, 0);
					
					//2. 업무로직
					int result = new Staff_BoardSerivce().insertBoard(b);

					//3. 뷰단 처리
					String msg = result>0?"게시글 등록 성공!":"게시글 등록 실패!";
					String loc = "/gogo-admin/staff/staffBoardView?staffNo="+staffNo+"&boardNo="+b.getStaff_BoardNo()+"&cPage=1";
