 ...
 */
@WebServlet("/gogo-admin/staff/staffBoardView")
public class SBoardViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SBoardViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(hasRead == false) {
            ...
            boardCookie.setPath(request.getContextPath()+"/gogo-admin/staff/staffBoardView");
		...
		if(b ==null) {
			msg="해당하는 게시글이 없습니다";
			loc="/gogo-admin/staff/staffBoardList";
			...
			request.getRequestDispatcher("/WEB-INF/views/staff/staffBoardView.jsp").forward(request, response);
		}
