 ...
 */
@WebServlet("/gogo-admin/staff/staffBoardUpdateEnd")
public class SBoardUpdateEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SBoardUpdateEndServlet() {
        super();
...
//								= new DefaultFileRenamePolicy();
				...
				MultipartRequest multiReq 
					...
					String loc = "/gogo-admin/staff/staffBoardView?boardNo="+b.getStaff_BoardNo()+"&cPage="+cPage;
