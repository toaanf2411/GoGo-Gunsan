 ...
 */
@WebServlet("/admin/staffBoardUpdateEnd")
public class StaffBoardUpdateEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StaffBoardUpdateEndServlet() {
        super();
...
//								= new DefaultFileRenamePolicy();
				...
				MultipartRequest multiReq 
					...
					String loc = "/gogo-admin/staffBoardView?boardNo="+b.getStaff_BoardNo()+"&cPage="+cPage;
