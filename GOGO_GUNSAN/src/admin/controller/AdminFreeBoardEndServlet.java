...
/**
 * Servlet implementation class AdminFreeBoardEndServlet
 */
@WebServlet("/admin/adminFreeBoardFormEnd")
public class AdminFreeBoardEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeBoardEndServlet() {
        super();
...
//						= new DefaultFileRenamePolicy();
		...
		MultipartRequest multiReq 
			...
			FreeBoard b =new FreeBoard(0, boardTitle, boardWriter, boardContent, originalFileName, renamedFileName, null, 0);
			
			//2. 업무로직
			int result = new FreeBoardSerivce().insertBoard(b);

			//3. 뷰단 처리
			String msg = result>0?"게시글 등록 성공!":"게시글 등록 실패!";
			String loc = "/gogo-admin/adminFreeBoardView?boardNo="+b.getFreeBoardNo()+"&cPage=1";
