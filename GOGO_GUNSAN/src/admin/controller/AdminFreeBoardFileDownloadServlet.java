...
/**
 * Servlet implementation class AdminFreeBoardFileDownloadServlet
 */
@WebServlet("/gogo-admin/adminFreeBoardFileDownload")
public class AdminFreeBoardFileDownloadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeBoardFileDownloadServlet() {
        super();
