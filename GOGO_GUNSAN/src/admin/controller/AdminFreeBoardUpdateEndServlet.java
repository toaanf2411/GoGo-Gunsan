...
/**
 * Servlet implementation class AdminFreeBoardUpdateEndServlet
 */
@WebServlet("/gogo-admin/adminFreeBoardUpdateEnd")
public class AdminFreeBoardUpdateEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeBoardUpdateEndServlet() {
        super();
...
//						= new DefaultFileRenamePolicy();
		...
		MultipartRequest multiReq 
			...
			String loc = "/gogo-admin/adminFreeBoardView?boardNo="+b.getFreeBoardNo()+"&cPage="+cPage;
