 ...
 */
@WebServlet("/board/admin_boardCommon/adminBoardUpdateEndCommon")
public class AdminBoardUpdateEndCommonServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardUpdateEndCommonServlet() {
        super();
...
//								= new DefaultFileRenamePolicy();
				...
				MultipartRequest multiReq 
					...
					AdminBoard b =new AdminBoard(boardNo, boardTitle, boardWriter, boardContent, originalFileName, renamedFileName, null, 0);
					...
					if(!"".equals(oldOriginalFileName)) {
						...
						if(f == null) {
							b.setAdminOriginalFileName(oldOriginalFileName);
							b.setAdminRenamedFileName(oldRenamedFileName);
					...
					//2. 업무로직
					int result = new AdminBoardSerivce().updateBoard(b);

					//3. 뷰단 처리
					String msg = result>0?"게시글 수정 성공!":"게시글 수정 실패!";
					String loc = "/board/admin_boardCommon/adminBoardViewCommon?boardNo="+b.getAdminBoardNo()+"&cPage="+cPage;
