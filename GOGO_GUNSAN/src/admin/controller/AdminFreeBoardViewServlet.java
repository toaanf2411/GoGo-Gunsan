...
/**
 * Servlet implementation class AdminFreeBoardViewServlet
 */
@WebServlet("/gogo-admin/adminFreeBoardView")
public class AdminFreeBoardViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeBoardViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hasRead == false) {
			...
			boardCookie.setPath(request.getContextPath()+"/gogo-admin/adminFreeBoardView");
		...
		if(b ==null) {
			...
			request.getRequestDispatcher("/WEB-INF/views/admin/adminFreeBoardView.jsp").forward(request, response);
		}
	}
