 ...
 */
@WebServlet("/gogo-admin/staffBoardFormEnd")
public class StaffBoardFormEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StaffBoardFormEndServlet() {
        super();
...
//								= new DefaultFileRenamePolicy();
				...
				MultipartRequest multiReq 
					...
					String loc = "/gogo-admin/staffBoardView?boardNo="+b.getStaff_BoardNo()+"&cPage=1";
