...
/**
 * Servlet implementation class AdminFreeBoardUpdateServlet
 */
@WebServlet("/gogo-admin/adminFreeBoardUpdate")
public class AdminFreeBoardUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeBoardUpdateServlet() {
        super();
