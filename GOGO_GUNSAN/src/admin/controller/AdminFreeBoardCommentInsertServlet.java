...
/**
 * Servlet implementation class AdminFreeBoardCommentInsertServlet
 */
@WebServlet("/gogo-admin/adminFreeBoardCommentInsert")
public class AdminFreeBoardCommentInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeBoardCommentInsertServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//파라미터 핸들링
				...
				String msg = "";
				String loc = "/gogo-admin/adminFreeBoardView?boardNo="+freeBoardRef+"&cPage="+cPage;
				if(result>0) {
					msg = "댓글 입력 성공!";
				}else {
					msg = "댓글 입력 실패!";
