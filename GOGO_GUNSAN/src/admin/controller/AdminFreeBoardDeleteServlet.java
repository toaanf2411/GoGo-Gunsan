...
/**
 * Servlet implementation class AdminFreeBoardDeleteServlet
 */
@WebServlet("/gogo-admin/adminFreeBoardDelete")
public class AdminFreeBoardDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeBoardDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new FreeBoardSerivce().deleteBoard(boardNo);
				...
				if(result>0 && !"".equals(rName)){
					...
					String savePath = root + "upload/board/free_board";
...
//					deleteFile.renameTo(newFile);
		...
		String msg ="";
		String loc ="/gogo-admin/adminFreeBoardView";
