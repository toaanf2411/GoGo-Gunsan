 ...
 */
@WebServlet("/board/admin_board/adminBoardUpdateEnd")
public class AdminBoardUpdateEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardUpdateEndServlet() {
        super();
...
//								= new DefaultFileRenamePolicy();
				...
				MultipartRequest multiReq 
					...
					String loc = "/board/admin_board/adminBoardView?boardNo="+b.getAdminBoardNo()+"&cPage="+cPage;
