 ...
 */
@WebServlet("/board/admin_board/adminBoardFormEnd")
public class AdminBoardFormEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardFormEndServlet() {
        super();
...
//								= new DefaultFileRenamePolicy();
				...
				MultipartRequest multiReq 
					...
					String loc = "/board/admin_board/adminBoardView?boardNo="+b.getAdminBoardNo()+"&cPage=1";
