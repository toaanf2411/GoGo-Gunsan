 ...
 */
@WebServlet("/board/staff_board/staff_BoardView")
public class Staff_BoardViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Staff_BoardViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hasRead == false) {
			...
			boardCookie.setPath(request.getContextPath()+"/board/staff_board");
