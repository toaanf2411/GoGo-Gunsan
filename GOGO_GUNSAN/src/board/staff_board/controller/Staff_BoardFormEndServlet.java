 ...
 */
@WebServlet("/board/staff_board/staff_BoardFormEnd")
public class Staff_BoardFormEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Staff_BoardFormEndServlet() {
        super();
...
//								= new DefaultFileRenamePolicy();
				...
				MultipartRequest multiReq 
					...
					String loc = "/board/staff_board/staff_BoardView?boardNo="+b.getStaff_BoardNo()+"&cPage=1";
