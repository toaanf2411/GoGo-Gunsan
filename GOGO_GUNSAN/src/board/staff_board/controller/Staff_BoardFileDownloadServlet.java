...
/**
 * Servlet implementation class staff_BoardFileDownloadServlet
 */
@WebServlet("/board/staff_board/staff_BoardFileDownload")
public class Staff_BoardFileDownloadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Staff_BoardFileDownloadServlet() {
        super();
