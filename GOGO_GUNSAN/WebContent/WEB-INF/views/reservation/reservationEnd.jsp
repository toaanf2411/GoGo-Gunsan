...
<%
	...
	int totalAmount = reservation.getAdultAmount()+reservation.getChildAmount();
			...
			<div class="row text-center ">
				...
				<h3>저희 GOGO GUNSAN 맞춤 서비스를 이용해 주셔서 감사합니다.</h3>
					<div class="ticket">
						<div class="stub">
							<div class="top">
								<span class="admit">예약번호</span> <span class="line"></span> <span
									class="num"> <%=reservation.getReservationId()%> </span>
							</div>
							<div class="number">1</div>
							<div class="invite"><%=tourInfoName %></div>
						</div>
						<div class="check">
							<div class="big"><%=tourInfoName %></div>
							<div class="number">#1</div>
							<div class="info">
								<section>
									<div class="title">날짜</div>
									<div><%=reservation.getTourDateTime() %></div>
								</section>
								<section>
									<div class="title">예약 인원 수</div>
									<div><%=totalAmount%></div>
								</section>
								<section>
