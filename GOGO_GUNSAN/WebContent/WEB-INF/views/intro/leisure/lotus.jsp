...
<div class="gunsan-page-title">
	...
	<div class="board">
        <div class="A-1_View">	
            <div class="viewImg">
                <ul>
                    <li><img src="<%=request.getContextPath()%>/images/tour_image/레저체험/연꽃재배.jpg" alt="연꽃재배" /></li>
                </ul>
            </div>
        </div>
        ...
        <div class="viewField">
            ...
            <div class="fieldBasic">
                <ul>
                    <li class="i-1"><i class='fas fa-pen' style='font-size:16px'></i><p>오산마을(연꽃재배)</p></li><!-- i-1, 명칭 -->
    ...
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>체험시기 : 3월~10월</h5>
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>휴 무 일 : </h5>
    <ul class="bu01 h5Box">
    <li>연꽃재배지에서 연꽃, 연근 등 연꽃에 대한 다양한 활용방안을 소개하고 있다.</li></ul>
    <h5 class="h5">주차시설</h5>
    <div class="h5Box">
    <ul class="bu01">
    <li>있음</li>
