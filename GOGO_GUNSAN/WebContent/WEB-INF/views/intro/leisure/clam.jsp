...
<div class="gunsan-page-title">
	...
	<div class="board">
        <div class="A-1_View">	
            <div class="viewImg">
                <ul>
                    <li><img src="<%=request.getContextPath()%>/images/tour_image/레저체험/바지락캐기.jpg" alt="바지락캐기" /></li>
                </ul>
            </div>
        </div>
        ...
        <div class="viewField">
            ...
            <div class="fieldBasic">
                <ul>
                    <li class="i-1"><i class='fas fa-pen' style='font-size:16px'></i><p>신시도(바지락캐기)</p></li><!-- i-1, 명칭 -->
                    ...
                    <li class="i-4"><i class='far fa-clock' style='font-size:16px'></i><p>1월~12월 (년중 가능)</p></li><!-- i-4, 이용시간 -->
     
                </ul>
            </div>
            <div class="conText">
                    <h4 class="h4">신시도(바지락캐기)</h4>
    <div class="h4Box">
    ...
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>휴 무 일 : 1월~12월 (년중 가능)</h5>
    <ul class="bu01 h5Box">
    <li>주의사항:옷이 젖을 수 있으니 여벌의 옷, 장갑, 모자, 수건 등을 준비하세요~ 체험 시작 30분 전까지 도착해 접수를 하셔야 합니다. 바지락캐기 체험은 물때에 따라 진행되니 체험시간은 전화로 문의 바랍니다.</li></ul>
    <h5 class="h5">주차시설</h5>
    <div class="h5Box">
    <ul class="bu01">
    <li>있음</li>
    ...
    <tbody>
    <tr>
    <td colspan="3">체험비 : 5,000원 (호미, 바구니, 조개 담을 망은 무료 제공) / 장화 대여료 : 2,000원</td>
