...
<div class="gunsan-page-title">
	...
	<div class="board">
        <div class="A-1_View">	
            <div class="viewImg">
                <ul>
                    <li><img src="<%=request.getContextPath()%>/images/tour_image/박물관전시관/근대건축관.jpg" alt="근대건축관" /></li>
                </ul>
            </div>
        </div>
        ...
        <div class="viewField">
            ...
            <div class="fieldBasic">
                <ul>
                    <li class="i-1"><i class='fas fa-pen' style='font-size:16px'></i><p>근대건축관</p></li><!-- i-1, 명칭 -->
                    
                    <li class="i-2"><i class='fas fa-phone-volume' style='font-size:16px'></i><p>063-446-9811</p></li><!-- i-2, 문의처 -->	
    ...
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>문 의 처 : 063-446-9811</h5>
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>이용시간 : 10:00 ~ 17:00</h5>
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>휴 무 일 : 토, 일 휴무</h5>
    <ul class="bu01 h5Box">
    <li>일제강점기 침탈적 자본주의를 상징하는 대표적인 은행이었다. 2008년 보수·복원 과정을 거쳐 군산 근대건축관으로 활용하고 있다.</li></ul>
    <h5 class="h5">주차시설</h5>
    <div class="h5Box">
    <ul class="bu01">
    <li>있음</li>
