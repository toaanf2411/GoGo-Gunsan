...
<div class="gunsan-page-title">
	...
	<div class="board">
        <div class="A-1_View">	
            <div class="viewImg">
                <ul>
                    <li><img src="<%=request.getContextPath()%>/images/tour_image/자연/선유도.jpg" alt="선유도" /></li>
                </ul>
            </div>
        </div>
        ...
        <div class="viewField">
            ...
            <div class="fieldBasic">
                <ul>
                    <li class="i-1"><i class='fas fa-pen' style='font-size:16px'></i><p>선유도</p></li><!-- i-1, 명칭 -->
                    
                    <li class="i-2"><i class='fas fa-phone-volume' style='font-size:16px'></i><p>063-465-5166</p></li><!-- i-2, 문의처 -->	
                    <li class="i-3"><i class='fas fa-map-marker-alt' style='font-size:16px'></i><p>전북 군산 옥도면 선유남길 34-22</p></li><!-- i-3, 주소 -->	
            ...
            <div class="conText">
                    <h4 class="h4">월명호수</h4>
    <div class="h4Box">
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>주 소 : 전북 군산 옥도면 선유남길 34-22</h5>
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>문 의 처 : 063-465-5166</h5>
    ...
    <ul class="bu01 h5Box">
    <li>선유도는 전라북도 군산시 옥도면 선유도리의 섬으로, 고군산군도의 중심지이자 관광지로 유명하다. 면적은 2.13 km², 해안선 길이는 12.8 km이다. </li></ul>
    <h5 class="h5">주차시설</h5>
    <div class="h5Box">
    <ul class="bu01">
    <li>있음</li>
