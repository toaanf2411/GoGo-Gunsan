...
<div class="gunsan-page-title">
	...
	<div class="board">
        <div class="A-1_View">	
            <div class="viewImg">
                <ul>
                    <li><img src="<%=request.getContextPath()%>/images/tour_image/자연/옥구저수지.jpg" alt="옥구저수지" /></li>
                </ul>
            </div>
        </div>
        ...
        <div class="viewField">
            ...
            <div class="fieldBasic">
                <ul>
                    <li class="i-1"><i class='fas fa-pen' style='font-size:16px'></i><p>옥구저수지</p></li><!-- i-1, 명칭 -->
                    
                    <li class="i-2"><i class='fas fa-phone-volume' style='font-size:16px'></i><p>　</p></li><!-- i-2, 문의처 -->	
                    <li class="i-3"><i class='fas fa-map-marker-alt' style='font-size:16px'></i><p>군산시 옥구읍 어은리</p></li><!-- i-3, 주소 -->	
            ...
            <div class="conText">
                    <h4 class="h4">옥구저수지</h4>
    <div class="h4Box">
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>주 소 : 전북 군산시 옥구읍 어은리</h5>
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>문 의 처 : </h5>
    ...
    <ul class="bu01 h5Box">
    <li>군산시 옥구읍 어은리 '옥구저수지'는 일제강점기인 지난 1921년 공사를 시작해 3년 뒤인 1923년 현재의 모습을 갖췄다. 옥구저수지는 토언제(제방을 흙으로 축조해 만든 저수지)다. </li></ul>
    <h5 class="h5">주차시설</h5>
    <div class="h5Box">
    <ul class="bu01">
    <li>있음</li>
