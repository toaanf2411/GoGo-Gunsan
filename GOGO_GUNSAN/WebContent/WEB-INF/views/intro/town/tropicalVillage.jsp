...
<div class="gunsan-page-title">
	...
	<div class="board">
        <div class="A-1_View">	
            <div class="viewImg">
                <ul>
                    <li><img src="<%=request.getContextPath()%>/images/tour_image/마을/열대자마을.jpg" alt="열대자마을" /></li>
                </ul>
            </div>
        </div>
        ...
        <div class="viewField">
            ...
            <div class="fieldBasic">
                <ul>
                    <li class="i-1"><i class='fas fa-pen' style='font-size:16px'></i><p>열대자 마을</p></li><!-- i-1, 명칭 -->
                    
                    <li class="i-2"><i class='fas fa-phone-volume' style='font-size:16px'></i><p>　</p></li><!-- i-2, 문의처 -->	
                    <li class="i-3"><i class='fas fa-map-marker-alt' style='font-size:16px'></i><p>전북 군산 미성동</p></li><!-- i-3, 주소 -->	
            ...
            <div class="conText">
                    <h4 class="h4">열대자 마을</h4>
    <div class="h4Box">
    <h5 class="h5"><i class='fas fa-check' style='font-size:24px;color:#4c72fc'></i>주 소 : 전북 군산 미성동/h5>
    ...
    <ul class="bu01 h5Box">
    <li>열대자 마을의 명칭은 광복 이후 불리어져 왔는데, 그 유래는 당시 이 마을에서 촌락과 촌락을 연결하는 농로의 폭이 15자 즉 열댓 자(尺)가 된다고 하여 열대자라 불렀다고 한다</li></ul>
    <h5 class="h5">주차시설</h5>
    <div class="h5Box">
    <ul class="bu01">
    <li>있음</li>
