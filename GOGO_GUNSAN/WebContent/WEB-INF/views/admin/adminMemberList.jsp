	...
	<div id="search-container">
		...
		<div id="search-memberNo">
			<form action="<%=request.getContextPath()%>/gogo-admin/memberFinder">
				...
				<div class="search__container">
					<input type="text" class="search__input" name="searchKeyword" placeholder="검색할 회원번호를 입력하세요.">
				</div>
			</form>
		</div>
		<div id="search-memberName">
			<form action="<%=request.getContextPath()%>/gogo-admin/memberFinder">
				...
				<div class="search__container">
					<input type="text" class="search__input" name="searchKeyword" placeholder="검색할 이름을 입력하세요.">
				</div>
			</form>
		</div>
	</div>
