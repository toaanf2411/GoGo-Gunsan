...
<section id="boardView">
							...
							<div class="board-view-footer">
								<div class="comment-container">
									...
									<div class="comment-editor">
										<form
											action="<%=request.getContextPath()%>/gogo-admin/adminFreeBoardCommentInsert"
	...
	%>
		...
		<!-- 게시물 삭제폼 -->
		<form
			action="<%=request.getContextPath()%>/gogo-admin/adminFreeBoardDelete"
...
<script>
	//목록 이동 스크립트
	function list(){
		location.href = "<%=request.getContextPath()%>/gogo-admin/freeBoardList?cPage=<%=cPage%>";
	};
...
$(".btn-delete").click(function(){
	...
	location.href = "<%=request.getContextPath()%>/gogo-admin/adminFreeBoardCommentDelete?boardNo=<%=board.getFreeBoardNo()%>&cPage=<%=cPage%>&delNo="+$(this).val();
...
$(".btn-reply").click(function(){
	<% if(memberLoggedIn!=null){%>
		...
		var form = $("<form action='<%=request.getContextPath()%>/gogo-admin/adminFreeBoardCommentInsert' method='POST'></form>");
...
function updateBoard(){
	location.href = "<%=request.getContextPath()%>/gogo-admin/adminFreeBoardUpdate?boardNo=<%=board.getFreeBoardNo()%>&cPage=<%=cPage%>";
...
function fileDownload(oName, rName){
	...
	location.href = "<%=request.getContextPath()%>/gogo-admin/adminFreeBoardFileDownload"+ "?oName=" + oName + "&rName=" + rName;
